...
public class BigRamTester {
    ...
    private static final long RESERVED_SPACE = 2L * 1024L * 1024L * 1024L; // 10 GB
    ...
    //原子性的long型变量
    private final AtomicLong curIter = new AtomicLong(0);

    private static final long ITERATIONS = (long) 2e8;
    ...
    private void accessCache(int keys) throws InterruptedException {
        ...
        while (true) {
            ...
            long currentIteration = curIter.getAndIncrement();
